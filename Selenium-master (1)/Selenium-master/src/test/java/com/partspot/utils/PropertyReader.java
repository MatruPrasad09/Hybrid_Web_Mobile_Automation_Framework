...
public class PropertyReader {
    ...
    private void getConfigProperties () {
        try {
            inputStreamConfig = new FileInputStream("./src/test/java/com/partspot/configs/prod_config.properties");
    ...
    private void loadPropertiesPerEnv () {
        try {
            ...
            if (environment.toLowerCase().equalsIgnoreCase("PROD")) {
                inputStreamEnvSpecConfig = new FileInputStream("./src/test/java/com/partspot/configs/prod_config.properties");
